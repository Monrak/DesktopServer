...
partial class AboutForm
{
    ...
    private void InitializeComponent()
    {
        ...
        lblProductName.Location = new Point(23, 148);
        lblProductName.Margin = new Padding(4, 0, 4, 0);
        lblProductName.Name = "lblProductName";
        lblProductName.Size = new Size(589, 59);
        lblProductName.TabIndex = 1;
        lblProductName.Text = "Monrak Desktop Server Lite";
        // 
        // lblVersion
        // 
        ...
        lblVersion.Location = new Point(41, 230);
        ...
        txtDescription.Location = new Point(78, 284);
        txtDescription.Margin = new Padding(4, 0, 4, 0);
        txtDescription.Multiline = true;
        txtDescription.Name = "txtDescription";
        txtDescription.ReadOnly = true;
        txtDescription.ScrollBars = ScrollBars.Vertical;
        txtDescription.Size = new Size(654, 246);
        ...
        pictureBox1.Size = new Size(445, 104);
